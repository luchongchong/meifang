...
if ($_REQUEST['act'] == 'list')
{
    ...
    $smarty->assign('action_link', array('text' => $_LANG['module_add'], 'href' => 'ad_position.php?act=add'));
...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $ad_number      = !empty($_POST['ad_number'])      ? intval($_POST['ad_number'])  : 0;
    ...
    {
        /* 将广告位置的信息插入数据表 */
        $sql = 'INSERT INTO '.$ecs->table('ad_position').' (position_name, ad_number, ad_height, position_desc, position_style) '.
               "VALUES ('$position_name', '$ad_number', '$ad_height', '$position_desc', '$_POST[position_style]')";
