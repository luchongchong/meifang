...
if ($_REQUEST['act'] == 'list')
{
    ...
    $smarty->assign('action_link', array('text' => $_LANG['module_add'], 'href' => 'ads.php?act=add'));
...
elseif ($_REQUEST['act'] == 'add')
{
    ...
    $smarty->assign('ur_here',       $_LANG['module_add']);
    $smarty->assign('action_link',   array('href' => 'ads.php?act=list', 'text' => $_LANG['module_add']));
