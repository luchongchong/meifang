function challs_flash_update(){ //<A href="http://www.zztuku.com/tags/Flash.html" target=_blank><U>Flash</U></A> 初始化函数 
...
//1为直接计算MD5签名后上传 
 ...
 //是否显示组件头部 
  ...
  //设置是否显示，全部清除<A href="http://www.zztuku.com/tags/按钮.html" target=_blank><U>按钮</U></A> 
...
function challs_flash_deleteAllFiles(){ //清空<A href="http://www.zztuku.com/tags/按钮.html" target=_blank><U>按钮</U></A>点击时，出发事件 
