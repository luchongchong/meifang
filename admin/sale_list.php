...
function get_sale_list($is_pagination = true){
    ...
    /* 查询数据的条件 */
    $where = " WHERE og.order_id = oi.order_id and oi.shop_no=os.shop_no and os.userid=ou.user_id
    ...
    $sql = "SELECT REPLACE(REPLACE(og.goods_attr, CHAR(10),''), CHAR(13), '') as goods_attr,og.goods_id, og.goods_sn, oi.goods_amount, oi.invoice_no,os.shop_no, ou.user_name, og.goods_name, og.goods_number AS goods_num, og.goods_price ".
