...
if (!$smarty->is_cached('fresco.dwt', $cache_id)){
    ...
    $smarty->assign('best_goods',       get_goods_list(46,1,6));//精品推荐    is_best->精品

    $smarty->assign('hot_goods',       get_goods_list(46,3,4));//热卖推荐


    $smarty->assign('goods_rand',       get_goods_list(46,0,8)); //壁画系列  显示8个
    $smarty->display('fresco.dwt', $cache_id);
}
