 ...
 * @return  void
 */
function show_message_c($content, $links = '', $hrefs = '', $type = 'info', $auto_redirect = true)
{
    assign_template();
    ...
    $GLOBALS['smarty']->assign('auto_redirect', $auto_redirect);
    $GLOBALS['smarty']->assign('message', $msg);
    $GLOBALS['smarty']->display('message_c.dwt');
...
function get_library_number($library, $template = null)
{
    ...
    else
    {
        ...
        $num = isset($static_page_libs[$template][$lib]) ? 3 :  3;
    }
