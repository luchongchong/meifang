...
function get_profile($user_id)
{
    ...
    $infos = array();
    /**
     * 添加字段,card_no,card_name,bank_name,bank_address
     * */
    $sql  = "SELECT user_name, birthday,address_id , sex, question, answer, rank_points, pay_points,user_money, user_rank,".
             " msn, qq, office_phone, home_phone, mobile_phone, passwd_question, passwd_answer,card_no,card_name,bank_name,bank_address ".
   ...
   // var_dump($infos);exit();
    ...
    $info['address_id']  = isset($infos['address_id'])  ? $infos['address_id']  : 0;
    ...
    $info['bank_address']      =$infos['bank_address'];
    return $info;
}
