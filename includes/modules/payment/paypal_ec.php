...
class paypal_ec
{
    ...
    function get_code($order, $payment)
    {
        ...
        $nvpstr="&Amt=".$paymentAmount."&PAYMENTACTION=".$paymentType."&ReturnUrl=".$returnURL."&CANCELURL=".$cancelURL ."&CURRENCYCODE=".$currencyCodeType ."&ButtonSource=MEIFANG_cart_EC_C2";
