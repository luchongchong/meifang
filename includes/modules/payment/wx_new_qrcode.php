    ...
    function respond()
    {
        ...
        if($notify->checkSign() == TRUE)
        {
            ...
            elseif($notify->data["result_code"] == "FAIL"){
                ...
                order_paid($log_id, 2); //更新订单状态
                //添加微信公众号通知功能
                $this->log(ROOT_PATH.'/data/wx_new_log.txt','通知功能'.'111111111'."\r\n");
                ...
                $str="恭喜家人,您的相关订单(".$order_sn.")共计".$amount."元已经付款成功,请等待返利";
                ...
                $weixin->valid();
                echo $weixin->text($str)->reply();//自动回复功能
                return true;
            }
