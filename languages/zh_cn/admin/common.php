...
$_LANG['add_order'] = '老式添加订单';
$_LANG['09_delivery_order'] = '发货单列表';
$_LANG['10_back_order'] = '退货单列表';

//erp系统
$_LANG['01_purchase_order'] = '采购订单';
$_LANG['02_purchase_order_examine'] = '采购订单申请';
$_LANG['03_order_payment'] = '付款画面';
$_LANG['04_order_shipping_handler'] = '发货处理';
...
$_LANG['11_user_fan_data_ranking']='粉丝数据排名';
...
//门店管理
$_LANG['21_mendian_manage'] = '门店管理';
$_LANG['01_mendian_list'] = '门店列表';
$_LANG['02_mendian_add'] = '门店添加';
$_LANG['03_mendian_clerk'] = '门店添加';
$_LANG['03_ymendian_yuyue'] = '门店预约列表';
$_LANG['03_gongchang_houtai'] = '工厂后台';
//分利管理
$_LANG['23_affiliate']      ='分利管理';
$_LANG['01_affiliate_list'] ='分利策略列表';

//工厂发货
$_LANG['factory_delivery']      ='工厂管理';
$_LANG['factory_delivery_list']      ='工厂发货';
$_LANG['factory_stock']             ='进货单列表';

//样本订单管理
//$_LANG['sample_manage']  = "样本订单管理";
$_LANG['sample_manage_list']  = "样本订单列表";
$_LANG['sample_manage_add'] = "添加样本订单";

//物料订单管理
$_LANG['materiel_manage_list']  = "物料销售订单";

//辅料订单管理
$_LANG['accessories_manage_list'] = "辅料销售订单";

$_LANG['order_management'] = "订单管理";

//费用管理
$_LANG['cost_management']  = "费用管理";
$_LANG['ecs_subject']  = "费用科目";
$_LANG['ecs_person']  = "费用相关人";
$_LANG['ecs_fee']  = "费用列表";

//费用管理
$_LANG['goods_warehousing']  = "商品入库";
$_LANG['goods_warehousings']  = "入库商品";

//银行账目
$_LANG['bank_management']  = "银行账目";
$_LANG['bank_account']  = "账目明细";
$_LANG['bank_cost_name']  = "费用名称";
$_LANG['bank_department']  = "部门名称";
$_LANG['bank_name']  = "银行名称";

//仓储管理
$_LANG['goods_warehousing']  = "仓储管理";
$_LANG['goods_warehousings']  = "库存查询";
$_LANG['sample_delivery_list']  = "样本发货";

//名师推荐(主题管理)
$_LANG['24_theme'] = '主题管理';
$_LANG['01_theme_list'] ='主题列表';
$_LANG['02_theme_add'] = '添加主题';
$_LANG['03_theme_good'] = '主题商品';
$_LANG['04_theme_add'] = '主题添加';

//分利明细
$_LANG['02_affiliate_details']                ='分利明细';
$_LANG['affiliate_order_sn']                  ='订单号';
$_LANG['affiliate_user_id']                   ='会员编号' ;
$_LANG['affiliate_user_name']                 ='会员名称';
$_LANG['affiliate_user_money']                ='分得金额';
$_LANG['affiliate_change_desc']               ='分利说明';
$_LANG['affiliate_change_time']               ='分利时间';

//施工队管理
$_LANG['22_shigongdui_manage']='施工队管理';
$_LANG['01_shigongdui_list']='施工队列表';
$_LANG['01_shigongdui_add']='施工队添加';
/* 虚拟卡 */
...
//分利字段
$_LANG['affiliate_name'] ='策略名字';
$_LANG['top_sell']       ='服务商收益' ;
$_LANG['top_service']    ='管理粉丝收益';
$_LANG['parent']         ='介绍粉丝收益';
$_LANG['install_1']        ='销售收益';
$_LANG['sell']           ='施工收益';
$_LANG['introduce']      ='介绍开店收益';
//主题列表
$_LANG['theme_name']                  ='主题名字';
$_LANG['theme_designer']              ='设计师' ;
$_LANG['theme_designer_pro']          ='设计师介绍';
$_LANG['theme_cover']                 ='封面';
$_LANG['theme_addtime']               ='添加时间';
$_LANG['01_theme_add']                = '主题添加';

/* 商之翼学院 */
$_LANG['01_school'] = 'ECShop在线手册';
$_LANG['02_school_a'] = 'ECShop视频教程';
