...
$_LANG['tab_color'] = '花色效果';

$_LANG['lab_goods_name'] = '商品名称：';
$_LANG['lab_goods_sn'] = '商品货号：';
$_LANG['lab_commodity_valuation'] = '商品计价：';
...
$_LANG['lab_is_gain_rebate']='是否分利';
$_LANG['lab_is_on_firm']    ='选择分利策略';
...
$_LANG['color_img_desc'] = '图片描述';
$_LANG['color_img_url'] = '上传文件';
$_LANG['color_img_file'] = '或者输入外部图片链接地址';
