...
$_LANG['p_y']['link_start'] = '<a href="http://www.68ecshop.com" target="_blank" >';
$_LANG['p_y']['link_p'] = '';
$_LANG['p_y']['link_r'] = '';
$_LANG['p_y']['link_b'] = '';
$_LANG['p_y']['main_start'] = '<img alt="ecshop" src="http://www.68ecshop.com/Remote_images/footer2.png"></img>';
$_LANG['p_y']['main_e'] = '';
$_LANG['p_y']['main_c'] = '';
$_LANG['p_y']['main_p'] = '';
$_LANG['p_y']['v_s'] = '';
$_LANG['p_y']['v'] = '';
$_LANG['p_y']['link_end'] = '</a>';
...
$_LANG['p_login_failure']= '用户名或密码错误';
$_LANG['p_login_failure_1'] = '登陆失败';
?>