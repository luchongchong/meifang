...
function get_user_default($user_id)
{
    ...
    $sql = "SELECT qcode_id,pay_points,user_rank,user_money, credit_line, last_login, is_validated FROM " .$GLOBALS['ecs']->table('users'). " WHERE user_id = '$user_id'";
    $row = $GLOBALS['db']->getRow($sql);
    $info = array();
