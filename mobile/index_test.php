...
dump(111);
//$str=get_cat_list(45);
dump(get_goods_list(45,1));exit();
//$smarty->assign('qiangzhi_goods',       get_cat_goods(45));     // 热买商品
...
function get_goods_list($cat_id,$type)
{
    ...
    $sql="SELECT * FROM ". $GLOBALS['ecs']->table('goods'). " WHERE cat_id in (".$cat_list .")" ." And " .$where."  limit 4";
    $good_list=$GLOBALS['db']->getAll($sql);
    return $good_list;
