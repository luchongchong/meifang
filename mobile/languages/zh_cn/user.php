...
$_LANG['edit_password_failure'] = '修改不正确！';
$_LANG['edit_password_success'] = '修改成功！';
...
$_LANG['pay_image_upload'] = "银行凭证上传";
$_LANG['pay_image_upload_err'] = "图片上传错误";
/* 订单状态 */
...
//评论
$_LANG['comment_failure']="评论失败";
$_LANG['comment_success']="评论成功";
$_LANG['comment_lnk']    ="返回评论页";
$_LANG['order_lnk']      ="返回我的订单页";
/* 密码找回问题 */
