<?php exit;?>a:3:{s:8:"template";a:2:{i:0;s:53:"/mnt/www/meifang/mobile/themesmobile/mobile/goods.dwt";i:1;s:64:"/mnt/www/meifang/mobile/themesmobile/mobile/library/comments.lbi";}s:7:"expires";i:1491879508;s:8:"maketime";i:1491879508;}<!DOCTYPE html>
<html>
<head>
...
wx.config({
    ...
    timestamp: 1491879508,
    nonceStr: '7iylkwreihbce17empqac9fl1yaqxauy',
    signature: '0cf7705f9963057e03f7ce53a921db3c116cd6ea',
    jsApiList: [
		'onMenuShareTimeline',
...
wx.ready(function () {
    ...
    title: 'RB101系列-5软包0.8密度板2.5海绵',
    link: 'http://test.mfmb58.com/mobile/goods4.php?id=3304',
    imgUrl: '../images/201611/source_img/3304_G_1479418739520.jpg',
    success: function () { 
...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="../images/201611/thumb_img/3304_thumb_G_1479418739429.jpg"  alt="RB101系列-5软包0.8密度板2.5海绵" /></a></div>-->
      <ul>
        <li><a href="javascript:showPic()" id="first_img"><img   alt="" src="../images/201611/source_img/3304_G_1479418739520.jpg"/></a></li>
         
         
         
         
                <li><a href="javascript:showPic()"><img alt="" src="../images/201611/goods_img/_P_20161118133851_76.jpg"/></a></li>
         
         
                <li><a href="javascript:showPic()"><img alt="" src="../images/201611/goods_img/_P_20161118133851_39.jpg"/></a></li>
         
         
                <li><a href="javascript:showPic()"><img alt="" src="../images/201611/goods_img/_P_20161118133852_19.jpg"/></a></li>
    ...
    <a class="collect_self" id="collect_box" href="javascript:collect(3304)"><img src="themesmobile/mobile/img/ico_star.png"></a>
...
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <form action="javascript:addToCart(3304)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
        ...
        <ul class="ul2">
          ...
          <h2>型号：</h2>
            <div class="items">
                                ...
                                <input type="radio" name="spec_227" value="46372" id="spec_value_46372" checked onclick="changePrice(46372)" />
          <label for="spec_value_46372">方形</label> 
                    <input type="radio" name="spec_227" value="46373" id="spec_value_46373"  onclick="changePrice(46373)" />
          <label for="spec_value_46373">欧式 拉扣</label> 
                    <input type="radio" name="spec_227" value="46376" id="spec_value_46376"  onclick="changePrice(46376)" />
          <label for="spec_value_46376">菱形</label> 
                    <input type="radio" name="spec_227" value="46374" id="spec_value_46374"  onclick="changePrice(46374)" />
          <label for="spec_value_46374">艺术</label> 
                    <input type="radio" name="spec_227" value="46375" id="spec_value_46375"  onclick="changePrice(46375)" />
          <label for="spec_value_46375">异形</label> 
                                  </div>
      </li>
                    <li>
          <h2>规格：</h2>
            <div class="items">
                                ...
                                <input type="radio" name="spec_230" value="46377" id="spec_value_46377" checked onclick="changePrice(46377)" />
          <label for="spec_value_46377">定制</label> 
                                  </div>
      </li>
...
<!--  <script>
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:3304;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
<button type="button" class="btn buy radius5" onClick="addToCart_quick(3304)">立即购买</button>
<button type="button" class="btn cart radius5" onclick="addToCart(3304);"><div class="ico_01"></div>加入购物车</button>
<script type="text/javascript">
      function showDiv(){
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="../images/201611/source_img/3304_G_1479418739520.jpg"> </div>
            <div id="right">
              <p>RB101系列-5软包0.8密度板2.5海绵</p>
