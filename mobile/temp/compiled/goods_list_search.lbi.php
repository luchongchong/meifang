...
?> 
      ...
      <div id="more_element_1" class="product flex_in single_item">
        <div class="pro-inner">
          ...
          <?php if ($this->_var['goods']['is_sample'] == 1): ?>
          <a href="sample_info.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" > 
           <?php else: ?> 
           <a href="<?php echo $this->_var['goods']['url']; ?>" > 
            <?php endif; ?> 
          <img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" alt="<?php echo $this->_var['goods']['goods_name']; ?>"> </a> </div>
          ...
          <a href="sample_info.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" > 
           ...
           <a href="<?php echo $this->_var['goods']['url']; ?>" > 
            ...
            <div class="proIcons"> 
			 <?php if ($this->_var['goods']['good_lable']): ?> 
			<span class="proIcons_span"><?php echo $this->_var['goods']['good_lable']; ?></span>
			<?php endif; ?> 
			 </div>
          </div>
        </div>
