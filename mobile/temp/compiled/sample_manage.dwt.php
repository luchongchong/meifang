...
<div class="fengexian">
<p>样本总数</p>
<span><?php echo $this->_var['yangben_sum']; ?></span></div>
</li>
...
<div class="fengexian">
<p>样本总额</p>
<span><?php echo $this->_var['yangben_sum_money']; ?></span></div>
</li>

<li <?php if ($this->_var['user_rank'] != 103): ?>style="width:33%;"<?php endif; ?>>
<div class="fengexian" style="border-right: 0px dotted #ccc">
<p>样本余额</p>
<span><?php echo $this->_var['sample_money']; ?></span></div>
</li>
</ul>
<div class="clr" ></div>
</div>
...
<div class="jifen-box header_highlight" style=" margin:20px 10px 0px 10px;">
    ...
    <?php $_from = $this->_var['sample_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'sample');if (count($_from)):
    foreach ($_from AS $this->_var['sample']):
?>
    <tr>
     <td><?php if ($this->_var['sample']['goods_thumb']): ?><img src="http://www.mfmb58.com/<?php echo $this->_var['sample']['goods_thumb']; ?>" width="46" /><?php endif; ?></td>
    <td><?php echo $this->_var['sample']['goods_name']; ?></td>
    <td><?php echo $this->_var['sample']['sales_price']; ?></td>
    <td><?php echo $this->_var['sample']['sales_time']; ?></td>
    <td><a href="http://wap.guoguo-app.com/wuliuDetail.htm?mailNo=<?php echo $this->_var['sample']['send_sn']; ?>"><font color="#FFFFFF"><?php echo $this->_var['sample']['send_sn']; ?></font></a></td>
    </tr>
