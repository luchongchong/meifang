...
<div class="fengexian">
<p>订单总数</p>
<span><?php echo $this->_var['count']; ?></span></div>
</li>
...
<div class="fengexian">
<p>成交金额</p>
<span><?php echo $this->_var['total_money']; ?></span></div>
</li>

<li>
<div class="fengexian">
<p>收益金额</p>
<span><?php echo $this->_var['money']; ?></span></div>
</li>
</ul>
<div class="clr"></div>
</div>
...
?>
    <?php if ($this->_var['user']['user_money'] == '0.00'): ?>
    <?php else: ?>       
    <tr>
  	<td ><?php echo $this->_var['user']['order_sn']; ?></td>
  	<td ><?php echo $this->_var['user']['user_name']; ?></td>
  	<td ><?php echo $this->_var['user']['user_money']; ?></td>
  	<td ><?php echo $this->_var['user']['change_desc']; ?></td>
    </tr>
    <?php endif; ?>
